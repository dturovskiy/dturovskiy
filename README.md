...
<p align="center">
  DeusApps · AI Browser Tools · SketchUp/Blender Tools · Python/Linux Automation · TypeScript SaaS · Unity/C#
</p>
...
* Built Python CLI/data tooling for market-data export, automation workflows, and local developer utilities.
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,ruby,ts,js,cs,unity,blender,nextjs,nestjs,postgres,prisma,redis,docker,linux,bash,git,github,githubactions,md&perline=8" />
</p>

**Platform stack:** TypeScript, JavaScript, pnpm workspaces, Next.js, NestJS, PostgreSQL, Prisma, Docker Compose, Redis, MinIO, structured JSON logging, GitHub Actions, and SaaS-oriented modular architecture.

**Tooling stack:** Python, Ruby, SketchUp Ruby API, Blender workflows, Chrome Extension MV3, CLI/TUI tools, automation scripts, Linux server tooling, Git/GitHub automation, and documentation-first releases.
...
* Building local-first AI/browser utilities for everyday developer workflows
* Maintaining **Deus AI Limits Extension** as a minimal Chrome MV3 usage-limit monitor
...
* Creating reusable Git/GitHub automation, release scripts, and project packaging flows
